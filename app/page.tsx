                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <motion.div
                            ...
                            className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-md border border-white/20 shadow-lg cursor-pointer hover:bg-white/30 transition"
                        >
                ...
                >
                    ...
                    <div className="space-y-3">
                        {[1, 2, 3].map((i) => (
                            ...
                            >
                                <div className={`w-12 h-12 rounded-full flex items-center justify-center text-white font-bold shadow-md ${i === 1 ? 'bg-emerald-500' : i === 2 ? 'bg-blue-500' : 'bg-amber-500'}`}>
                                    {i === 1 ? 'AR' : i === 2 ? 'SA' : 'BS'}
                                </div>
                                <div className="flex-1">
                                    <h3 className="text-sm font-bold text-slate-800">
                                        {i === 1 ? 'Ahmad Rizky' : i === 2 ? 'Siti Aminah' : 'Budi Santoso'}
                                    </h3>
                                    <p className="text-xs text-slate-500 font-medium">
                                        {i === 3 ? 'Guru Matematika' : 'Kelas 12 IPA 1'}
                                    </p>
                                </div>
                                <div className="text-right">
                                    ...
                                    <span className="text-[10px] text-slate-400">07:0{i} WIB</span>
                                </div>
                            </motion.div>
                        ))}
                    </div>
